...
public class FeedHelperTest {
  ...
  public static void setUpClass() throws IOException {
    privateFile = testFolder.newFile("feedhelpertest-private-file.txt");
    writeFile(privateFile, "This file is private!!!");
    evilDtd = testFolder.newFile("feedhelpertest-evil-dtd.dtd");
    writeFile(evilDtd,
  ...
  private FeedHelper<Gsafeed> helper;

  @Before
  public void setUp() throws Exception {
    helper = FeedHelper.getGsafeedHelper();
  }
